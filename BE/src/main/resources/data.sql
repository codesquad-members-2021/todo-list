...
insert into work (title, content, created_at, status, author_id) values('no1', 'create first todo', '2021-04-08 16:40', 1, 1);
insert into work (title, content, created_at, status, author_id) values('no2', 'create first doing', '2021-04-08 16:45', 2, 1);
insert into work (title, content, created_at, status, author_id) values('no3', 'create second todo', '2021-04-08 16:50', 1, 1);
insert into work (title, content, created_at, status, author_id) values('no4', 'create second doing', '2021-04-08 16:55', 2, 1);
insert into work (title, content, created_at, status, author_id) values('no5', 'create first done', '2021-04-08 17:00', 3, 1);
