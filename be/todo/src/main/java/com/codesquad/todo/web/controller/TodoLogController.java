...
public class TodoLogController {
    ...
    public ResponseEntity<Map<String, Object>> showTodoLogList() {
        ...
        todoLogs.add(new TodoLogDto(new TodoLog("'move' '1 자바스크립트 예제 실습 수정됨!' 'TODO' 'IN_PROGRESS'", author)));
        todoLogs.add(new TodoLogDto(new TodoLog("'move' '2 자바스크립트 예제 실습 수정됨!' 'TODO' 'IN_PROGRESS'", author)));
